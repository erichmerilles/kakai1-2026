...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <form method="POST">
            ...
            <div class="fixed-bottom fixed-action-bar p-3">
                <div class="container d-flex justify-content-end gap-3">
                    <button type="button" class="btn btn-outline-secondary" onclick="window.history.back()">Cancel</button>
                    <button type="submit" class="btn btn-warning px-5 fw-bold text-dark"><i class="bi bi-save me-2"></i>Save Permissions</button>
                </div>
            </div>
