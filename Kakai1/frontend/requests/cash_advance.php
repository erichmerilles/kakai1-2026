...
<head>
    ...
    <title>Cash Advance Requests | KakaiOne</title>
...
<body class="bg-light">
    ...
    <main id="main-content" style="margin-left: 250px; padding: 25px; transition: margin-left 0.3s;">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold text-dark"><i class="bi bi-cash-coin me-2 text-warning"></i>Cash Advance Requests</h3>
                </div>
            </div>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" class="text-center py-5 text-muted">
                                            ...
                                            No <?= strtolower($currentTab) ?> cash advance requests found.
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
    ...
    <script>
        function confirmAction(id, action) {
            let title = action === 'Approved' ? 'Approve Loan?' : 'Reject Loan?';
