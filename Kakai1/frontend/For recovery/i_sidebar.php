<div id="sidebar" class="d-flex flex-column">
    <div class="text-center mb-4">
        ...
        <a href="inventory_overview.php" class="nav-link active"><i class="bi bi-box-seam me-2"></i>Overview</a>
        <a href="inventory_manage.php" class="nav-link"><i class="bi bi-pencil-square me-2"></i>Manage Inventory</a>
        <a href="inventory_movements.php" class="nav-link"><i class="bi bi-arrow-left-right me-2"></i>Movements</a>
        <a href="inventory_analytics.php" class="nav-link"><i class="bi bi-bar-chart-line me-2"></i>Analytics</a>
